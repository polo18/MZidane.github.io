                ...
                <div class="row wide">
                    ...
                    <form role="search" method="get" class="s-header__search-form" action="{{ Route('posts.search') }}">
                        <label>
                            ...
                            <input type="search" class="s-header__search-field" name="search" id="search"
            ...
            <div class="row">
                <div class="column">
                    <div class="ss-copyright">
                        <span>© Copyright VEF {{ date('Y') }}</span>
                        <span>Design by <a href="#">Zizou polo</a></span>
